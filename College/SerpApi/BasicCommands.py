...
def rapidlyShiftingGet_cords_only(x1,y1,y2):                    # vertical shifting, from top to bottom # Example: (1,1,5)
    shiftingSpeedY = 1 #pilih sendiri
    currentX = x1
    currentY = y1
    
    while currentY < y2:
        currentXandY = currentX , currentY
        mousePos(currentXandY)
        get_cords_only()
...
def rapidlyShiftingRGBValue(x1,x2,y1):                  # horizontal shifting, from left to right # Example: (1,5,5)
    shiftingSpeedX = 1 #pilih sendiri
    currentX = x1
    currentY = y1
    ...
    while currentX < x2:
        ...
        mousePos(currentXandY)
        RGBValueTest()
        currentX = currentX + shiftingSpeedX
        time.sleep(0.3)
...
def rapidlyShiftingClick1(x1,y1,y2):             # vertical shifting, from top to bottom
    shiftingSpeedY = 2 #pilih sendiri
    currentX = x1
    currentY = y1
...
def roundDown(num, decimal_places=0):
	return int(math.trunc(num * 10**decimal_places) / 10**decimal_places)
