...
def randomize(randomTarget):
    randomx = random.randint(randomTarget[0], randomTarget[2])
    # print(randomx)
    randomy = random.randint(randomTarget[1], randomTarget[3])
    # print(randomy)
    
    choosenRandom = randomx, randomy
    # print(choosenRandom)
